...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/Azilchain.webp"),
      projectName: "Azilchain",
      projectDesc: "Full-stack development using React, Node, Contentful, AWS",
      footerLink: [
        {
          name: "Visit Website",
          url: "https://www.azilchain.com/"
        }
